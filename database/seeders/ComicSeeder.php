...
class ComicSeeder extends Seeder
{
    ...
    // Creo un ciclo sull'array comics per...
        foreach($comics as $comic){
            // ...istanziare tanti fumetti quanti sono gli elementi dell'array
            $new_comic = new Comic();

            //! ...trasformo i due array in due stringhe prima di popolare il db 
            $comic['artists'] = implode(', ', $comic['artists']);
            $comic['writers'] = implode(', ', $comic['writers']);

            // ...sfruttare la funzione fill per popolare la tabella        
            $new_comic->fill($comic);

            //! ...trasformo i due array in due stringhe dopo aver popolato il db 
            // $new_comic->artists = implode(', ', $com['artists']);
            // $new_comic->writers = implode(', ', $com['writers']);
